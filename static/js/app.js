...
function updateFilters() {
  ...
  function filterTable() {
    ...
    // This helped me visualize data structure
    console.log(Object.entries(filters))

    // Iterates over keys in filters object to filter table data
    filteredData = tableData.filter((obj) => {
    for(let filterId in filters) {
        if(obj[filterId] !== filters[filterId]) {return false}} return true});
    
    // Used to find length of filtered data
